...
public class AdvancedListFive extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_advanced_list_five);

        Intent intent = getIntent();
        Bundle bundle = intent.getExtras();
        District_Service = bundle.getString(Constants.D);
        Name_Service = bundle.getString(Constants.N);
        FHName_Service = bundle.getString(Constants.FH);
        DOB_Service = bundle.getString(Constants.DOB);
        Pincode_service = bundle.getString(Constants.P);
        ...
        if (isOnline()) {
           ...
           CD.showDialog(AdvancedListFive.this,"Network isn't available");
        }
    ...
    class FiveParameters_Async extends AsyncTask<String,String,String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                url_ =new URL("http://hp.gov.in/uidreport/AWW.svc/Search");
        ...
        protected void onPostExecute(String result) {
            ...
            if(userlist.isEmpty()){
               CD.showDialog(AdvancedListFive.this," No match found");

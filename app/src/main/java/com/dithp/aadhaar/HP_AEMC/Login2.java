...
public class Login2 extends Activity implements AsyncTaskListener {
    ...
    private void getOtpandAadhaa() {
        ...
        if(!otp.isEmpty()){
            if(otp.length()== 6){
                if(AppStatus.getInstance(Login2.this).isOnline()) {
                    ...
                    url2 = sb.toString();
                    Log.e("OTP URL",url2);
                    new Generic_Async_Get(Login2.this, Login2.this, TaskType.OTP_USER).execute(url2);
                } else {
                    CM.showDialog(Login2.this,"Network isn't available");

                }
            }else{
                CM.showDialog(Login2.this,Constants.OTPError1);
            }
        }else{
            CM.showDialog(Login2.this,Constants.OTPError2);
        }
        ...
        if(!aadhaar.isEmpty() ){
            if(aadhaar.length() == 12 ){
                ...
                if(AppStatus.getInstance(Login2.this).isOnline()){
                    ...
                    new Generic_Async_Get(Login2.this, Login2.this, TaskType.USER_LOGIN).execute(url);
                }
                else CM.showDialog(Login2.this,"Network isn't available");
            }else CM.showDialog(Login2.this,Constants.AError1);
        }else CM.showDialog(Login2.this,Constants.AError2);
    }
    ...
    public void onTaskCompleted(String result, TaskType taskType) {
        ...
        if(taskType == TaskType.USER_LOGIN){
            ...
            if(finalResult.equalsIgnoreCase(Constants.Login_Success)){
                CM.showDialog(Login2.this,finalResult);
            ...
            if(finalResult.equalsIgnoreCase(Constants.OTP_Successfull)){
                ...
                Intent i = new Intent(Login2.this,SRDH_Search_Screen.class);
            ...
            CM.showDialog(Login2.this,"Something went wrong");
        }
    }
